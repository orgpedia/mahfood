...
import/websites/gr.maharashtra.gov.in/Food:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Food .
...
import: check_env import/websites/gr.maharashtra.gov.in/Food .secrets/google.token import/models/ai4bharat/IndicTrans2-en/ct2_int8_model
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Food import/documents
